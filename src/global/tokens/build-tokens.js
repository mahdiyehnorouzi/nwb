...
// Combine all tokens for each theme
const darkTokens = {
  ...
  // Simple aliases with direct values
...
// Set light theme as default in :root, then override with dark theme
const css = 
  generateThemeBlock(lightTokens, ':root') +
  generateThemeBlock(darkTokens, ':root[data-theme="dark"]');
